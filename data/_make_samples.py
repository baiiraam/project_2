...
def draw_broccoli(d, cx, cy, n=4):
    ...
    for i in range(n):
        ...
        # stalk
        d.rectangle(
            [cx + ox - 4, cy + oy + 2, cx + ox + 4, cy + oy + 18], fill=(200, 220, 160)
        )
...
def draw_salmon(d, cx, cy, w=70, h=45):
    ...
    for off in (-25, -10, 5, 20):
        d.line(
            [(cx + off - 30, cy - h + 12), (cx + off + 30, cy - h + 16)],
            fill=(180, 90, 70),
            width=1,
        )
        d.line(
            [(cx + off - 30, cy + h - 14), (cx + off + 30, cy + h - 18)],
            fill=(180, 90, 70),
            width=1,
        )
...
def draw_avocado(d, cx, cy, w=45, h=55):
    ...
    # inner flesh ring
    d.ellipse(
        [cx - w + 10, cy - h + 12, cx + w - 10, cy + h - 12],
        fill=(180, 200, 110),
        outline=(140, 170, 80),
    )
    # pit
    d.ellipse(
        [cx - 16, cy - 16, cx + 16, cy + 16], fill=(120, 80, 40), outline=(80, 50, 25)
    )
...
def draw_bread(d, cx, cy, w=70, h=45):
    ...
    d.rounded_rectangle(
        [cx - w + 10, cy - h + 10, cx + w - 10, cy + h - 10],
        radius=10,
        fill=(240, 215, 165),
    )
